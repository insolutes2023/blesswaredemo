        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="why-choose-one__right">
                    <div class="section-title text-left">
                        <span class="section-title__tagline">Low Costs Energy</span>
                        <h2 class="section-title__title">Improving the energy efficiency of a building</h2>
                    </div>
                    <p class="why-choose-one__text">Lorem ipsum production of solar electricity, you are less
                        dependent on the power grid and its pricing policy. There are no moving mechanisms and
                        components in the solar power plant.</p>
                    <div class="why-choose-one__points-box">
                        ...
                        <ul class="list-unstyled why-choose-one__points why-choose-one__points-two">
                            <li>
                                <div class="icon">
                                    <span class="icon-renewable-energy-1"></span>
                                </div>
                                <div class="text">
                                    <p>Renewable <br> Energy</p>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                    <span class="icon-atomic-energy"></span>
                                </div>
                                <div class="text">
                                    <p>For Many <br> Purposes</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="why-choose-one__btn-box">
                        <a href="contact.html" class="why-choose-one__btn thm-btn">Discover more</a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="team-two">
    <div class="team-two__shape-2" style="background-image: url(assets/images/shapes/team-two-shape-2.png);">
    </div>
    <div class="container">
        <div class="section-title text-center">
            <span class="section-title__tagline">Our Experts People</span>
            <h2 class="section-title__title">Meet the best solar <br> expert workers</h2>
        </div>
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                <div class="team-two__single">
                    ...
                    <div class="team-two__content">
                        <h3 class="team-two__name"><a href="team.html">David Johan</a></h3>
                        <p class="team-two__sub-title">Engineer</p>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                <div class="team-two__single">
                    ...
                    <div class="team-two__content">
                        <h3 class="team-two__name"><a href="team.html">Sarah Albert</a></h3>
                        <p class="team-two__sub-title">Engineer</p>
                        <ul class="list-unstyled team-two__social-two">
                            <li><a href="#"><i class="fas fa-share-alt"></i></a></li>
                        </ul>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                <div class="team-two__single">
                    ...
                    <div class="team-two__content">
                        <h3 class="team-two__name"><a href="team.html">Mark Harry</a></h3>
                        <p class="team-two__sub-title">Engineer</p>
                        <ul class="list-unstyled team-two__social-two">
                            <li><a href="#"><i class="fas fa-share-alt"></i></a></li>
                        </ul>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                <div class="team-two__single">
                    ...
                    <div class="team-two__content">
                        <h3 class="team-two__name"><a href="team.html">Aleesha Brown</a></h3>
                        <p class="team-two__sub-title">Engineer</p>
                        <ul class="list-unstyled team-two__social-two">
                            <li><a href="#"><i class="fas fa-share-alt"></i></a></li>
                        </ul>
                    ...
                    <div class="news-two__left-img">
                        ...
                        <div class="news-two__left-img-content">
                            <ul class="news-two__left-meta list-unstyled">
                                <li>
                                    <a href="news-details.html"><i class="fas fa-user-circle"></i>by
                                        Christine</a>
                                </li>
                                <li>
                            ...
                            <h3 class="news-two__left-title"><a href="news-details.html">We Believe in Building
                                    Long Lasting <br> our Business Relationships</a></h3>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="news-two__single">
                                ...
                                <div class="news-two__content">
                                    <ul class="news-two__meta list-unstyled">
                                        ...
                                        <li>
                                            <a href="news-details.html"><i class="fas fa-comments"></i>2
                                                Comments</a>
                                        </li>
                                    </ul>
                                    <h3 class="news-two__title"><a href="news-details.html">We Believe in
                                            Building Long Lasting our Business Relationships</a></h3>
                                </div>
                            </div>
                        </li>
                        <li>
